            ...
            <div class="card-body">
              <table class="table table-bordered" width="100%" cellspacing="0">
                <tbody>
                  <tr>
                    <td>Today</td>
                    <td>BDT <?php echo getSalesGrandTotal("DAY"); ?></td>
                  </tr>
                  <tr>
                    <td>This Week</td>
                    <td>BDT <?php echo getSalesGrandTotal("WEEK"); ?></td>
                  </tr>
                  <tr>
                    <td>This Month</td>
                    <td>BDT <?php echo getSalesGrandTotal("MONTH"); ?></td>
                  </tr>
                  <tr class="table-info">
                    <td><b>All Time</b></td>
                    <td><b>BDT <?php echo getSalesGrandTotal("ALLTIME"); ?></b></td>
                  </tr>
                </tbody>
              </table>
            </div>
